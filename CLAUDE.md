...
- **Existe algum objetivo de negócio que deveria influenciar decisões técnicas (ex: precisa escalar pra milhões de usuários desde o dia um, ou é um MVP validando hipótese)?** Trata-se de um projeto pequeno, para uso pessoal. Minha intenção é utilizá-lo localmente inicialmente, mas possivelmente vou evoluir para hospedar numa solução PaaS ou IaaS.
