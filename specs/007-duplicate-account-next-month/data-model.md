...
Nenhum desses campos novos é persistido no backend além da própria cópia criada — `copiedIds` é inteiramente descartado ao sair da tela ou recarregar a página.
